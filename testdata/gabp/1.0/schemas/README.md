...
Each method has dedicated request/response schemas that inherit from the envelope structure while adding method-specific
validation.
...
Shared definitions like error objects, tool definitions, capability structures, and reusable attention objects.
